...
#ratio = int(w * 1 / )
Header.config(font=("Fraktur", int(60*w/1536),"bold"), fg="gold",bg="#152238")
#root.overrideredirect(True)
...
def refresh(event):
    ...
    for openImage_frames in ImageSequence.Iterator(openImage):
        ...
        gif_Label1.place(relx=0.88, rely=0.48, anchor="sw")
    ...
    gif_idle1.place(relx=0.88, rely=0.48, anchor="sw")
    ...
    if prize_amount<=0:
        ...
        winnter.config(font=("Ariel", int(30*w/1536),"bold"), fg="white", bg="#152238")
        winnter.place(relx=0.2 + 0.24 * int(count_num/5), rely=0.25+0.1 * int(count_num%5), anchor="center")
...
button_1.place(relx=1, rely=1, anchor="sw")
